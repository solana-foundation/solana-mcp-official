...
- **Analytics** ([`lib/services/s3/analytics.ts`](lib/services/s3/analytics.ts)): Tool calls + initializations are buffered in memory and uploaded as JSONL objects to `s3://lz-solana-raw-data/mcp_analytics/`.
