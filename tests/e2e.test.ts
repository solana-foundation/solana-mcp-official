...
describe.skip("e2e", () => {
  ...
  it("Search should return results as structured content", async () => {
    ...
    expect(structuredContent.results).toBeInstanceOf(Array);
  ...
  it("Fetch should return results as structured content", async () => {
    ...
    expect(structuredContent.id).toBeDefined();
    expect(structuredContent.title).toBeDefined();
    expect(structuredContent.text).toBeDefined();
    expect(structuredContent.url).toBeNull();
    expect(structuredContent.metadata).toBeNull();
  });
});
