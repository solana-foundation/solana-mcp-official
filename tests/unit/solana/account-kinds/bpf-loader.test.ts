...
import { buildBpfLoaderPayload, buildBpfLoader2Payload } from "../../../../lib/solana/account-kinds/bpf-loader";

describe("bpf-loader account kind payload", () => {
  it("builds payload with correct kind and owner_program for BPF Loader 1", () => {
    const result = buildBpfLoaderPayload({
      kind: "bpf-loader",
      account: {
    ...
    expect(result).toMatchObject({
      entity: {
        kind: "bpf-loader",
        owner_program: BPF_LOADER_PROGRAM_ID,
        address: "Prog1111111111111111111111111111111111111111",
  ...
  it("builds payload with correct kind and owner_program for BPF Loader 2", () => {
    const result = buildBpfLoader2Payload({
      kind: "bpf-loader-2",
      account: {
